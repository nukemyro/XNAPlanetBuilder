...
//VS_OUT VS_Color(VertexShaderInput input)
//{
...
VertexShaderOutput VertexShaderFunction(VertexShaderInput input)
{
	...
	float h = tex2Dlod(heightMapSampler, float4(input.UV, 0, 0)).r * 0.05;
	float4 Nn = mul(input.Normal, world);
	float4 NewPos = pos + Nn * h;

	output.Position = mul(NewPos, viewProjection);

	//float4 pos = mul(input.Position, world);
	/*float pmod = .25;
	pos.z = input.Color.r == 1 && input.Color.g == 0 && input.Color.b == 0 && input.Color.a == 1 ? pos.z - pmod : pos.z;
	pos.x = input.Color.r == 1 && input.Color.g == 1 && input.Color.b == 0 && input.Color.a == 1 ? pos.x - pmod : pos.x;
	pos.x = input.Color.r == 1 && input.Color.g == 1 && input.Color.b == 1 && input.Color.a == 1 ? pos.x + pmod : pos.x;
	pos.z = input.Color.r == 1 && input.Color.g == 1 && input.Color.b == 1 && input.Color.a == 0 ? pos.z + pmod : pos.z;*/
	...
	pos.y += orgY * scaleToUse.xz;
	output.Position = mul(pos, vp);
    
    output.TexCoord = ((pos.xz/mod) * 256) / scaleToUse.xz;
